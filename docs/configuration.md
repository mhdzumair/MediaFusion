...
- **formula_ext_scheduler_crontab** (default: `"*/30 * * * *"`)
- **motogp_ext_scheduler_crontab** (default: `"0 5 * * *"`)
- **wwe_ext_scheduler_crontab** (default: `"10 */3 * * *"`)
- **ufc_ext_scheduler_crontab** (default: `"30 */3 * * *"`)
- **movies_tv_ext_scheduler_crontab** (default: `"0 * * * *"`)
