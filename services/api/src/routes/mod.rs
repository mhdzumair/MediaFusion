...
pub fn router(state: Arc<AppState>) -> Router {
    Router::new()
        ...
        .route("/api/v1/import/iptv-settings", get(content::m3u_import::get_iptv_settings))
        // ── HTTP stream import ────────────────────────────────────────────────
        ...
        .route("/api/v1/content/suggestions", get(content::suggestions::list_my_suggestions))
