...
def get_router() -> APIRouter:
    ...
    from reference.routers.rss.rss_feeds import router as rss_feeds_router  # noqa: PLC0415
    from reference.routers.rss.user_rss import router as user_rss_router  # noqa: PLC0415
