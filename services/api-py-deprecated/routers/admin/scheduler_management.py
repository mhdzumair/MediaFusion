...
from reference.routers.user.auth import require_role
from db.config import settings
from db.enums import UserRole
from db.models import User
from db.redis_database import REDIS_ASYNC_CLIENT
from workers.scrapy.task import run_spider, run_spider_in_process
from workers.scrapers.background_scraper import BackgroundSearchWorker, run_background_search
from workers.scrapers.dmm_hashlist import run_dmm_hashlist_scraper
from workers.scrapers.feed_scraper import (
    JackettFeedScraper,
    ProwlarrFeedScraper,
...
from workers.scrapers.rss_scraper import RssScraper, run_rss_feed_scraper
from workers.scrapers.scraper_tasks import cleanup_expired_scraper_task
from workers.scrapers.trackers import update_torrent_seeders
from workers.scrapers.tv import validate_tv_streams_in_db
from workers.providers.cache_helpers import cleanup_expired_cache
...
SCHEDULER_JOBS = {
    ...
    "formula_ext": {
        ...
        "category": "scraper",
        "description": "Scrapes Formula racing content from ext.to",
    ...
    "motogp_ext": {
        ...
        "category": "scraper",
        "description": "Scrapes MotoGP racing content from ext.to",
    ...
    "wwe_ext": {
        ...
        "category": "scraper",
        "description": "Scrapes WWE wrestling content from ext.to",
    ...
    "ufc_ext": {
        ...
        "category": "scraper",
        "description": "Scrapes UFC fighting content from ext.to",
    ...
    "movies_tv_ext": {
        ...
        "category": "scraper",
        "description": "Scrapes movies and TV series from ext.to",
    ...
    "x1337": {
        "display_name": "1337x",
        "category": "scraper",
        "description": "Scrapes public torrents from 1337x",
        "crontab_setting": "x1337_scheduler_crontab",
        "disable_setting": "disable_x1337_scheduler",
    },
    "thepiratebay": {
        "display_name": "The Pirate Bay",
        "category": "scraper",
        "description": "Scrapes public torrents from The Pirate Bay",
        "crontab_setting": "thepiratebay_scheduler_crontab",
        "disable_setting": "disable_thepiratebay_scheduler",
    },
    "rutor": {
        "display_name": "RuTor",
        "category": "scraper",
        "description": "Scrapes public torrents from RuTor",
        "crontab_setting": "rutor_scheduler_crontab",
        "disable_setting": "disable_rutor_scheduler",
    },
    "limetorrents": {
        "display_name": "LimeTorrents",
        "category": "scraper",
        "description": "Scrapes public torrents from LimeTorrents",
        "crontab_setting": "limetorrents_scheduler_crontab",
        "disable_setting": "disable_limetorrents_scheduler",
    },
    "yts": {
        "display_name": "YTS",
        "category": "scraper",
        "description": "Scrapes public movie torrents from YTS",
        "crontab_setting": "yts_scheduler_crontab",
        "disable_setting": "disable_yts_scheduler",
    },
    "bt4g": {
        "display_name": "BT4G RSS",
        "category": "scraper",
        "description": "Scrapes BT4G RSS feed for movie and series torrents",
        "crontab_setting": "bt4g_scheduler_crontab",
        "disable_setting": "disable_bt4g_scheduler",
    },
    "nyaa": {
        "display_name": "Nyaa",
        "category": "scraper",
        "description": "Scrapes anime torrents from Nyaa",
        "crontab_setting": "nyaa_scheduler_crontab",
        "disable_setting": "disable_nyaa_scheduler",
    },
    "animetosho": {
        "display_name": "AnimeTosho",
        "category": "scraper",
        "description": "Scrapes anime torrents from AnimeTosho",
        "crontab_setting": "animetosho_scheduler_crontab",
        "disable_setting": "disable_animetosho_scheduler",
    },
    "subsplease": {
        "display_name": "SubsPlease",
        "category": "scraper",
        "description": "Scrapes anime release listings from SubsPlease",
        "crontab_setting": "subsplease_scheduler_crontab",
        "disable_setting": "disable_subsplease_scheduler",
    },
    "animepahe": {
        "display_name": "AnimePahe",
        "category": "scraper",
        "description": "Scrapes hoster-style anime pages from AnimePahe",
        "crontab_setting": "animepahe_scheduler_crontab",
        "disable_setting": "disable_animepahe_scheduler",
    },
    "bt52": {
        "display_name": "52BT",
        "category": "scraper",
        "description": "Scrapes public torrents from 52BT",
        "crontab_setting": "bt52_scheduler_crontab",
        "disable_setting": "disable_bt52_scheduler",
    },
    "uindex": {
        "display_name": "UIndex",
        "category": "scraper",
        "description": "Scrapes public torrents from UIndex",
        "crontab_setting": "uindex_scheduler_crontab",
        "disable_setting": "disable_uindex_scheduler",
    },
    "eztv_rss": {
        "display_name": "EZTV RSS",
        "category": "scraper",
        "description": "Scrapes EZTV RSS feed for torrent metadata",
        "crontab_setting": "eztv_rss_scheduler_crontab",
        "disable_setting": "disable_eztv_rss_scheduler",
    },
