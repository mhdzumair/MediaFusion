...
def get_router() -> APIRouter:
    ...
    from reference.routers.streaming.cache import router as cache_router  # noqa: PLC0415
    from reference.routers.streaming.playback import router as playback_router  # noqa: PLC0415
...
def get_provider_router() -> APIRouter:
    ...
    """
    from workers.providers.debridlink.api import router as debridlink_router  # noqa: PLC0415
    from workers.providers.premiumize.api import router as premiumize_router  # noqa: PLC0415
    from workers.providers.realdebrid.api import router as realdebrid_router  # noqa: PLC0415
    from workers.providers.seedr.api import router as seedr_router  # noqa: PLC0415
