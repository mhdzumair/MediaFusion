...
from workers.providers.easynews.client import Easynews
from workers.providers.exceptions import ProviderException
from workers.providers.usenet_file_selection import (
...
async def get_video_url_from_easynews(
    ...
    **kwargs: Any,
    ...
    async with initialize_easynews(streaming_provider) as easynews:
        # Always resolve with the requesting user's credentials.
