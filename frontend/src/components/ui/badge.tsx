  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-emerald-600/90 text-white shadow-sm",
        warning:
          "border-transparent bg-orange-500/90 text-white shadow-sm",
        info:
          "border-transparent bg-sky-600/90 text-white shadow-sm",
        muted:
