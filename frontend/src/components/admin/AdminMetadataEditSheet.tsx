...
export function AdminMetadataEditSheet({
  ...
  // Update field helper
  const updateField = <K extends keyof MetadataUpdateRequest>(
    field: K, 
    value: MetadataUpdateRequest[K]
  ) => {
  ...
  const handleCreateGenre = useCallback(async (name: string) => {
    await createGenre.mutateAsync({ name })
  }, [createGenre])
  
  const handleCreateCatalog = useCallback(async (name: string) => {
    await createCatalog.mutateAsync({ name })
  }, [createCatalog])
  
  const handleCreateStar = useCallback(async (name: string) => {
  ...
  const getTypeIcon = () => {
    switch (catalogType) {
      ...
      case 'tv': return <Radio className="h-4 w-4" />
  ...
  const getTypeBadgeColor = () => {
    switch (catalogType) {
      ...
      case 'series': return 'bg-blue-500/10 text-blue-500'
              ...
              <div className="py-6 space-y-6">
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="flex gap-6">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <Label htmlFor="is_poster_working" className="text-sm cursor-pointer">Poster Working</Label>
                      </div>
                      <div className="flex items-center gap-2">
                        <Switch
                        ...
                        />
                        <Label htmlFor="is_add_title_to_poster" className="text-sm cursor-pointer">Add Title to Poster</Label>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => updateField('imdb_rating', e.target.value ? parseFloat(e.target.value) : undefined)}
                            className="rounded-xl"
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => updateField('tmdb_rating', e.target.value ? parseFloat(e.target.value) : undefined)}
                            className="rounded-xl"
                          />
                        </div>
                        <div className="grid gap-2">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm text-muted-foreground bg-muted/30 p-3 rounded-xl">
                    ...
                    <div>
                      <span className="text-muted-foreground/70">Streams:</span>{' '}
                      {metadata?.total_streams ?? 0}
                    </div>
                    <div>
