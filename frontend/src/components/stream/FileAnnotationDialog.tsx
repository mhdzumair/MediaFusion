...
export function FileAnnotationDialog({
  ...
  const toggleFileInclusion = useCallback((fileId: number) => {
    setEditedFiles((prev) =>
      prev.map((f) =>
        f.file_id === fileId ? { ...f, included: !f.included } : f
      )
    )
  }, [])
    ...
    setEditedFiles((prev) =>
      prev.map((f) => {
        ...
        return {
          ...
          episode_end: null,
          isModified:
            original?.season_number !== null ||
            original?.episode_number !== null ||
            original?.episode_end !== null,
        }
      })
    )
  }, [initialFiles])
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          "h-7 px-2",
                          viewMode === 'filename' && "bg-emerald-500/20"
                        )}
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          "h-7 px-2",
                          viewMode === 'full' && "bg-emerald-500/20"
                        )}
        ...
        <div className="px-6 py-2 bg-blue-500/5 border-b flex-shrink-0">
          <div className="flex items-start gap-2 text-xs text-blue-400">
            ...
            <span>
              ...
              and <kbd className="px-1 py-0.5 rounded bg-blue-500/20 text-[10px]">▶</kbd> for consecutive episode numbering (continues from current or starts at 1).
            </span>
          </div>
        </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {file.isModified && file.included && (
                      <Badge variant="secondary" className="bg-emerald-500/20 text-emerald-400 text-[10px] flex-shrink-0">
                        Modified
                      </Badge>
                    )}
                  </div>
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent className="max-w-xs">
                              ...
                              <p className="text-muted-foreground mt-1">
                                Continues from current episode number, or starts at 1 if empty.
                                Resets when season changes.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent className="max-w-xs">
                                ...
                                <p className="text-muted-foreground mt-1">
                                  If a single file contains multiple consecutive episodes (e.g., E01-E03), 
                                  set Episode to 1 and Episode End to 3.
                                </p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
