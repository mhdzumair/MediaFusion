...
import { ExternalLink, MonitorPlay, Tv, PlaySquare, Smartphone, Copy, Check, AlertCircle } from 'lucide-react'
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant={variant === 'prominent' ? 'outline' : 'ghost'} size="sm" className={buttonClass}>
