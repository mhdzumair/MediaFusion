  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure additional services to enhance your streaming experience
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <AccordionItem value="mediaflow">
            <AccordionTrigger>
              <div className="flex items-center gap-2">
                ...
                {mfc && <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-500">Enabled</Badge>}
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={!!mfc}
                  onCheckedChange={enableMediaFlow}
                />
              </div>
                ...
                <>
                  ...
                  <div className="space-y-4 pt-2">
                    ...
                    <div className="p-3 rounded-lg bg-muted/50 text-sm space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        To enable/disable MediaFlow proxy for Stremio or Kodi, go to your streaming provider settings and toggle "Use MediaFlow Proxy" for each provider individually.
                      </p>
                    </div>
                  </div>
                </>
          ...
          <AccordionItem value="rpdb">
            <AccordionTrigger>
              <div className="flex items-center gap-2">
                ...
                {rpc && <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-500">Enabled</Badge>}
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Use RPDB for enhanced rating posters
                  </p>
                </div>
                <Switch
                  checked={!!rpc}
                  onCheckedChange={enableRpdb}
                />
              </div>
              ...
              {rpc && (
                <>
                  ...
                  <p className="text-xs text-muted-foreground">
                    RPDB is an optional freemium service for enhanced rating posters. MediaFusion generates rating posters using IMDb ratings by default.
                  </p>
          ...
          <AccordionItem value="mdblist">
            <AccordionTrigger>
              <div className="flex items-center gap-2">
                ...
                {mdb && <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-500">Enabled</Badge>}
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Use MDBList for custom movie and TV show lists
                  </p>
                </div>
                <Switch
                  checked={!!mdb}
                  onCheckedChange={enableMdblist}
                />
              </div>
