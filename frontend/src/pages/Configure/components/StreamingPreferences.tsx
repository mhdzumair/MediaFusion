    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ⚙️ Streaming Preferences
        </CardTitle>
        <CardDescription>
          Configure resolution, quality, and sorting preferences for streams
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => onChange({ ...config, sr: selectedResolutions.length === RESOLUTIONS.length ? [] : RESOLUTIONS.map(r => r.value) })}
              >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => onChange({ ...config, qf: selectedQualities.length === QUALITY_GROUPS.length ? [] : QUALITY_GROUPS.map(q => q.id) })}
              >
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <Input
                ...
                className="w-24"
              />
              <p className="text-xs text-muted-foreground">Streams smaller than this will be filtered out. Set to 0 for no minimum.</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium tabular-nums">
                {isNoMaxLimit ? 'No Limit' : `${maxSizeGB} GB`}
              </span>
            </div>
            <Slider
              min={1}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => onChange({ ...config, ls: selectedLanguages.length === LANGUAGES.length ? [] : [...LANGUAGES] })}
              >
        ...
        <div className="space-y-4 pt-4 border-t">
          ...
          <div className="space-y-3 pt-2">
            ...
            <p className="text-xs text-muted-foreground">
              Choose how different stream types are ordered in results.
            </p>
        ...
        <div className="space-y-4 pt-4 border-t">
          ...
          <p className="text-xs text-muted-foreground">
            Filter streams by name using keywords or regex patterns.
          </p>
