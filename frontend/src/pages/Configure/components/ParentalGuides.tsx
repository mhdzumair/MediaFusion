  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Filter content based on age ratings and nudity levels
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="secondary">
              {isDisabled ? 'Disabled' : `${selectedCertifications.length} selected`}
            </Badge>
          </div>
          <p className="text-xs text-muted-foreground">
            Block content with certifications above the selected levels
          </p>
              ...
              return (
                ...
                >
                  <Check className={cn(
                    "h-4 w-4 shrink-0",
                    isSelected 
                      ? isDisableOption ? "text-primary" : "text-red-500"
                      : "text-transparent"
                  )} />
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="secondary">
              {isNudityDisabled ? 'Disabled' : `${selectedNudity.length} selected`}
            </Badge>
          </div>
          <p className="text-xs text-muted-foreground">
            Block content with nudity levels at or above selected options
          </p>
