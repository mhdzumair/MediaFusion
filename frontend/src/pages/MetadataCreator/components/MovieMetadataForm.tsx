...
export function MovieMetadataForm({ initialData, onSuccess, onCancel }: MovieMetadataFormProps) {
  ...
  const { data: availableGenres } = useGenres('movie')
  ...
  const [runtime, setRuntime] = useState(initialData?.runtime_minutes?.toString() || '')
  ...
  const [parentalCertificate, setParentalCertificate] = useState(initialData?.parental_certificate || '')
  ...
  const catalogSuggestions = useMemo(() => {
    return availableCatalogs?.movies.map(c => c.name) || []
  }, [availableCatalogs])
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditing && initialData) {
        const updateData: UserMediaUpdate = {
          ...
          runtime_minutes: runtime ? parseInt(runtime) : undefined,
          status: status.trim() || undefined,
          website: website.trim() || undefined,
          original_language: originalLanguage.trim() || undefined,
          nudity_status: nudityStatus || undefined,
          parental_certificate: parentalCertificate.trim() || undefined,
    ...
    title, originalTitle, year, releaseDate, description, tagline, posterUrl, backgroundUrl, logoUrl, runtime,
    status, website, originalLanguage, nudityStatus, parentalCertificate,
    genres, catalogs, akaTitles, cast, directors, writers, isPublic,
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur">
            <CardHeader>
              ...
              <CardDescription>
                Enter the movie's core details
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="runtime" className="flex items-center gap-1.5">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Released, In Production, etc."
                  />
                </div>
              </div>
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur">
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="parentalCertificate">Parental Certificate</Label>
                  <Input
                    id="parentalCertificate"
                    value={parentalCertificate}
                    onChange={(e) => setParentalCertificate(e.target.value)}
