...
pub fn router(state: Arc<AppState>) -> Router {
    ...
    let api_router = Router::new()
        ...
        // ── Admin DB handlers (admin_db module) ──────────────────────────────
        .route("/api/v1/admin/db/tables/{table}/schema", get(admin_db::get_table_schema))
        .route("/api/v1/admin/db/tables/{table}/data", get(admin_db::get_table_data))
        .route("/api/v1/admin/db/tables/{table}/export", get(admin_db::import_export::export_table))
        .route("/api/v1/admin/db/tables/{table}/rows/{id}/related", get(admin_db::introspect::get_related_rows))
        .route("/api/v1/admin/db/orphans", get(admin_db::orphans::detect_orphans_combined))
        .route("/api/v1/admin/db/orphans/cleanup", post(admin_db::orphans::cleanup_orphans))
        .route("/api/v1/admin/db/orphans/streams", get(admin_db::orphans::detect_orphan_streams))
        .route("/api/v1/admin/db/orphans/media", get(admin_db::orphans::detect_orphan_media))
        .route("/api/v1/admin/db/slow-queries", get(admin_db::get_slow_queries))
        .route("/api/v1/admin/db/slow-queries/reset", post(admin_db::reset_slow_queries))
        .route("/api/v1/admin/db/maintenance/vacuum", post(admin_db::maintenance::run_vacuum))
        .route("/api/v1/admin/db/maintenance/analyze", post(admin_db::maintenance::run_analyze))
        .route("/api/v1/admin/db/maintenance/reindex", post(admin_db::maintenance::run_reindex))
        .route("/api/v1/admin/db/maintenance/bloat", get(admin_db::maintenance::get_bloat_stats))
        .route("/api/v1/admin/db/indexes", get(admin_db::maintenance::list_indexes))
        .route("/api/v1/admin/db/indexes/rebuild", post(admin_db::maintenance::rebuild_indexes))
        .route("/api/v1/admin/db/bulk/delete", post(admin_db::bulk::bulk_delete))
        .route("/api/v1/admin/db/bulk/update", post(admin_db::bulk::bulk_update))
        ...
        .route("/api/v1/admin/keyword-filters/sync-status", get(admin_keyword_filters::keyword_sync_status))
        .route("/api/v1/admin/keyword-filters/reload", post(admin_keyword_filters::reload_keyword_cache))
        .route("/api/v1/admin/keyword-filters/reset", post(admin_keyword_filters::reset_keyword_filters))
        ...
        // ── Admin database (legacy /database/ prefix — points to canonical handlers) ─
        .route("/api/v1/admin/database/stats", get(admin::db_stats))
        .route("/api/v1/admin/database/tables", get(admin::db_tables))
        .route("/api/v1/admin/database/tables/{table}/schema", get(admin_db::get_table_schema))
        .route("/api/v1/admin/database/tables/{table}/data", get(admin_db::get_table_data))
        .route("/api/v1/admin/database/tables/{table}/rows", delete(admin_db::delete_table_rows))
        .route("/api/v1/admin/database/vacuum", post(admin_db::maintenance::run_vacuum))
        .route("/api/v1/admin/database/analyze", post(admin_db::maintenance::run_analyze))
        .route("/api/v1/admin/database/reindex", post(admin_db::maintenance::run_reindex))
        .route("/api/v1/admin/database/bloat", get(admin_db::maintenance::get_bloat_stats))
        .route("/api/v1/admin/database/slow-queries", get(admin_db::get_slow_queries))
        .route("/api/v1/admin/database/orphan-streams", get(admin_db::orphans::detect_orphan_streams))
        .route("/api/v1/admin/database/orphan-media", get(admin_db::orphans::detect_orphan_media))
        .route("/api/v1/admin/database/indexes", get(admin_db::maintenance::list_indexes))
        .route("/api/v1/admin/database/indexes/rebuild", post(admin_db::maintenance::rebuild_indexes))
        .route("/api/v1/admin/database/cleanup-orphans", post(admin_db::orphans::cleanup_orphans))
        .route("/api/v1/admin/database/export/{table}", get(admin_db::import_export::export_table))
        .route("/api/v1/admin/database/import/{table}", post(admin_db::import_export::import_execute))
        // ── Admin scrapers ────────────────────────────────────────────────────
        ...
        .route("/api/v1/admin/schedulers/{job_id}/logs", get(admin_scrapers::get_scheduler_job_logs))
        .route("/api/v1/admin/schedulers/stream", get(admin_scrapers::stream_scheduler_snapshots))
        // ── Admin tasks ───────────────────────────────────────────────────────
        ...
        .route("/api/v1/admin/tasks/{task_id}/stream", get(admin_scrapers::stream_task_detail))
