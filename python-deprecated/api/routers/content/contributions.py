...
from reference.routers.content.anonymous_utils import resolve_uploader_identity
from reference.routers.user.auth import require_auth, require_role
...
def get_import_processor(contribution_type: str):
    ...
    """
    if contribution_type == "torrent":
        from reference.routers.content.torrent_import import process_torrent_import  # noqa: PLC0415

        return process_torrent_import
    if contribution_type == "nzb":
        from reference.routers.content.nzb_import import process_nzb_import  # noqa: PLC0415

        return process_nzb_import
    if contribution_type == "youtube":
        from reference.routers.content.youtube_import import process_youtube_import  # noqa: PLC0415

        return process_youtube_import
    if contribution_type == "http":
        from reference.routers.content.http_import import process_http_import  # noqa: PLC0415

        return process_http_import
    if contribution_type == "acestream":
        from reference.routers.content.acestream_import import process_acestream_import  # noqa: PLC0415
...
async def _apply_contribution_review(
    ...
    """
    from reference.routers.content.torrent_import import AdultContentNotAllowedError  # noqa: PLC0415
