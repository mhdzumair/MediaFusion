...
# Removed streaming_providers imports
...
async def configure(
    ...
    # Removed streaming provider password masking logic
    ...
    # Removed torrent sorting options calculation
    # Removed language sorting calculation
    ...
    return TEMPLATES.TemplateResponse(
        "html/configure.html",
        {
            ...
            # Removed resolutions, sorting_options, sorted_languages, quality_groups, disabled_providers
...
def get_cache_key(
    ...
    is_watchlist_catalog = False # Watchlist catalogs depend on streaming provider

    # Removed streaming provider watchlist check
    if catalog_id.startswith("contribution_") and user_data.contribution_streams:
        cache_key = None
...
async def fetch_metas(
    ...
    if catalog_type == "tv":
        ...
        # Removed watchlist deletion logic dependent on streaming_providers.mapper
...
async def encrypt_user_data(
    ...
    async def _validate_all_config() -> dict:
        # Removed streaming provider check for p2p disable
    ...
    if existing_secret_str:
        ...
        # Removed streaming provider password/token restoration logic
...
# Removed streaming_provider_router inclusion
