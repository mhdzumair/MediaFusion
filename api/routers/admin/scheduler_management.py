...
SCHEDULER_JOBS = {
    ...
    "formula_tgx": {
        "display_name": "Formula TGX",
        "category": "scraper",
        "description": "Scrapes Formula racing content",
        "crontab_setting": "formula_tgx_scheduler_crontab",
        "disable_setting": "disable_formula_tgx_scheduler",
    },
    "nowmetv": {
    ...
    "motogp_tgx": {
        "display_name": "MotoGP TGX",
        "category": "scraper",
        "description": "Scrapes MotoGP racing content",
        "crontab_setting": "motogp_tgx_scheduler_crontab",
        "disable_setting": "disable_motogp_tgx_scheduler",
    },
    "arab_torrents": {
    ...
    "wwe_tgx": {
        "display_name": "WWE TGX",
        "category": "scraper",
        "description": "Scrapes WWE wrestling content",
        "crontab_setting": "wwe_tgx_scheduler_crontab",
        "disable_setting": "disable_wwe_tgx_scheduler",
    },
    "ufc_tgx": {
        "display_name": "UFC TGX",
        "category": "scraper",
        "description": "Scrapes UFC fighting content",
        "crontab_setting": "ufc_tgx_scheduler_crontab",
        "disable_setting": "disable_ufc_tgx_scheduler",
    },
    "movies_tv_tgx": {
        "display_name": "Movies TV TGX",
        "category": "scraper",
        "description": "Scrapes movies and TV series from TGX",
        "crontab_setting": "movies_tv_tgx_scheduler_crontab",
        "disable_setting": "disable_movies_tv_tgx_scheduler",
    },
    # Feed Scrapers
