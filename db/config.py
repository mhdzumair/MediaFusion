...
class Settings(BaseSettings):
    ...
    disable_formula_ext_scheduler: bool = True
    motogp_ext_scheduler_crontab: str = "0 5 * * *"
    disable_motogp_ext_scheduler: bool = True
    wwe_ext_scheduler_crontab: str = "10 */3 * * *"
    disable_wwe_ext_scheduler: bool = True
    ufc_ext_scheduler_crontab: str = "30 */3 * * *"
    disable_ufc_ext_scheduler: bool = True
    movies_tv_ext_scheduler_crontab: str = "0 * * * *"
    disable_movies_tv_ext_scheduler: bool = True
